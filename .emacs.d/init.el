  ...
  (let ((path (or (buffer-file-name) default-directory)))
    (when path
      (cond
       ...
       ((string-match "/home/hirai/devwork/pj" path)
        (setq frame-title-format "PROJECTOR"))
       ((string-match "/home/hirai/devwork/fp" path)
        (setq frame-title-format "FLATPANEL"))
       ((string-match "/home/hirai/devprivate" path)
        (setq frame-title-format "PRIVATE"))
       ((string-match "/home/hirai/docs/MemoData/" path)
        (setq frame-title-format "MemoData"))
       ((string-match "/home/hirai/.dotfiles/" path)
        (setq frame-title-format "Dotfiles"))))))
